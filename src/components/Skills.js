    ...
    <div className="container">
      <section className="skills" id="skills">
        <div className="skills-content section-content">
          ...
          <div className={`skills-toggle ${activeTab === 'tools' ? 'active' : ''}`} data-toggle-box>
      <button
        className={`toggle-btnfirst ${activeTab === 'skills' ? 'active' : ''}`}
        data-toggle-btn
      ...
      <button
        className={`toggle-btnfirst ${activeTab === 'tools' ? 'active' : ''}`}
        data-toggle-btn
      ...
      >
        ...
        {activeTab === 'skills' && (
          <ul
            className={`skills-list ${activeTab === "skills" ? "active" : ""}`}
          >
            <li>
        ...
        {activeTab === 'tools' && (
          <ul className={`tools-list ${activeTab === 'tools' ? 'active' : ''}`}>
            <li>
              <div className="skill-card">
